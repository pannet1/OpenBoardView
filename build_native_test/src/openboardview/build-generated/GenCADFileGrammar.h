 ...
 *********************************************************************************
  ...
  Do not modify this file, but edit the source data GenCADFileBnf.h
  or generator script generate_grammar_header.py
 *********************************************************************************
 *********************************************************************************
 **/
#define X_MACRO_PARSE_VARS X(s, "s")\
X(n, "n")\
X(sign, "sign")\
X(number, "number")\
...
X(wrapper_to_end, "wrapper_to_end")\
X(string_with_end, "string_with_end")\
...
X(part_name_to_end, "part_name_to_end")\
X(pin_name, "pin_name")\
X(probe, "probe")\
...
X(sig_name, "sig_name")\
X(sig_name_to_end, "sig_name_to_end")\
X(tan, "tan")\
...
X(included_in_device, "included_in_device")\
X(device, "device")\
X(devices, "devices")\
X(node, "node")\
X(nailloc, "nailloc")\
...
X(gencad_file, "gencad_file")\
 /*'empty' line to end last continuation*/
